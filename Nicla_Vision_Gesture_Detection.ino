...
/* Includes ---------------------------------------------------------------- */
#include <Gesty_do_Sterowania_inferencing.h>
...
const int gestureCooldown = 1000;
/**
...
void loop()
{
    ...
    //==================================================================================
    //===========IF_GESTURE_NOT_DETECTED_THEN_PRINT_BACKGROUND("TŁO" in Polish)=========
    //==================================================================================
    Serial.println("Tło");
    ...
    //=========================================================
    //=========================================================
    //===PREDICTION_OF_GESTURES_USED_FOR_CONTROLLING_SPOTIFY===
    //=========================================================
    //=========================================================
#else
    ...
    for (uint16_t i = 0; i < EI_CLASSIFIER_LABEL_COUNT; i++) {
        ...
        if (confidence > threshold && millis() - lastGestureTime > gestureCooldown) {
